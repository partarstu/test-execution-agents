...
export UNATTENDED_MODE="${UNATTENDED_MODE:-true}"
...
export BBOX_SCREENSHOT_LONGEST_ALLOWED_DIMENSION_PIXELS="${BBOX_SCREENSHOT_LONGEST_ALLOWED_DIMENSION_PIXELS:-5000}"
export BBOX_SCREENSHOT_MAX_SIZE_MEGAPIXELS="${BBOX_SCREENSHOT_MAX_SIZE_MEGAPIXELS:-10}"
export BOUNDING_BOX_ALREADY_NORMALIZED="${BOUNDING_BOX_ALREADY_NORMALIZED:-false}"

# --- Agent Model Configuration ---
# Element Bounding Box Agent
export ELEMENT_BOUNDING_BOX_AGENT_MODEL_NAME="${ELEMENT_BOUNDING_BOX_AGENT_MODEL_NAME:-claude-opus-4-5-20251101}"
export ELEMENT_BOUNDING_BOX_AGENT_MODEL_PROVIDER="${ELEMENT_BOUNDING_BOX_AGENT_MODEL_PROVIDER:-anthropic}"
export ELEMENT_BOUNDING_BOX_AGENT_PROMPT_VERSION="${ELEMENT_BOUNDING_BOX_AGENT_PROMPT_VERSION:-v1.0.0}"

# Element Selection Agent
export ELEMENT_SELECTION_AGENT_MODEL_NAME="${ELEMENT_SELECTION_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export ELEMENT_SELECTION_AGENT_MODEL_PROVIDER="${ELEMENT_SELECTION_AGENT_MODEL_PROVIDER:-google}"
export ELEMENT_SELECTION_AGENT_PROMPT_VERSION="${ELEMENT_SELECTION_AGENT_PROMPT_VERSION:-v1.0.0}"

# Page Description Agent
export PAGE_DESCRIPTION_AGENT_MODEL_NAME="${PAGE_DESCRIPTION_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export PAGE_DESCRIPTION_AGENT_MODEL_PROVIDER="${PAGE_DESCRIPTION_AGENT_MODEL_PROVIDER:-google}"
export PAGE_DESCRIPTION_AGENT_PROMPT_VERSION="${PAGE_DESCRIPTION_AGENT_PROMPT_VERSION:-v1.0.0}"

# Precondition Agent
export PRECONDITION_AGENT_MODEL_NAME="${PRECONDITION_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export PRECONDITION_AGENT_MODEL_PROVIDER="${PRECONDITION_AGENT_MODEL_PROVIDER:-google}"
export PRECONDITION_AGENT_PROMPT_VERSION="${PRECONDITION_AGENT_PROMPT_VERSION:-v1.0.0}"

# Precondition Verification Agent
export PRECONDITION_VERIFICATION_AGENT_MODEL_NAME="${PRECONDITION_VERIFICATION_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export PRECONDITION_VERIFICATION_AGENT_MODEL_PROVIDER="${PRECONDITION_VERIFICATION_AGENT_MODEL_PROVIDER:-google}"
export PRECONDITION_VERIFICATION_AGENT_PROMPT_VERSION="${PRECONDITION_VERIFICATION_AGENT_PROMPT_VERSION:-v1.0.0}"

# Test Case Extraction Agent
export TEST_CASE_EXTRACTION_AGENT_MODEL_NAME="${TEST_CASE_EXTRACTION_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export TEST_CASE_EXTRACTION_AGENT_MODEL_PROVIDER="${TEST_CASE_EXTRACTION_AGENT_MODEL_PROVIDER:-google}"
export TEST_CASE_EXTRACTION_AGENT_PROMPT_VERSION="${TEST_CASE_EXTRACTION_AGENT_PROMPT_VERSION:-v1.0.0}"

# Test Step Action Agent
export TEST_STEP_ACTION_AGENT_MODEL_NAME="${TEST_STEP_ACTION_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export TEST_STEP_ACTION_AGENT_MODEL_PROVIDER="${TEST_STEP_ACTION_AGENT_MODEL_PROVIDER:-google}"
export TEST_STEP_ACTION_AGENT_PROMPT_VERSION="${TEST_STEP_ACTION_AGENT_PROMPT_VERSION:-v1.0.0}"

# Test Step Verification Agent
export TEST_STEP_VERIFICATION_AGENT_MODEL_NAME="${TEST_STEP_VERIFICATION_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export TEST_STEP_VERIFICATION_AGENT_MODEL_PROVIDER="${TEST_STEP_VERIFICATION_AGENT_MODEL_PROVIDER:-google}"
export TEST_STEP_VERIFICATION_AGENT_PROMPT_VERSION="${TEST_STEP_VERIFICATION_AGENT_PROMPT_VERSION:-v1.0.0}"

# UI Element Description Agent
export UI_ELEMENT_DESCRIPTION_AGENT_MODEL_NAME="${UI_ELEMENT_DESCRIPTION_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export UI_ELEMENT_DESCRIPTION_AGENT_MODEL_PROVIDER="${UI_ELEMENT_DESCRIPTION_AGENT_MODEL_PROVIDER:-google}"
export UI_ELEMENT_DESCRIPTION_AGENT_PROMPT_VERSION="${UI_ELEMENT_DESCRIPTION_AGENT_PROMPT_VERSION:-v1.0.0}"

# UI State Check Agent
export UI_STATE_CHECK_AGENT_MODEL_NAME="${UI_STATE_CHECK_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export UI_STATE_CHECK_AGENT_MODEL_PROVIDER="${UI_STATE_CHECK_AGENT_MODEL_PROVIDER:-google}"
export UI_STATE_CHECK_AGENT_PROMPT_VERSION="${UI_STATE_CHECK_AGENT_PROMPT_VERSION:-v1.0.0}"

# API Endpoints
export GROQ_ENDPOINT="${GROQ_ENDPOINT:-https://api.groq.com/openai/v1}"
...
export GCE_IMAGE="${GCE_IMAGE:-projects/cos-cloud/global/images/cos-121-18867-90-106}"
...
export MAX_VM_RUN_DURATION="${MAX_VM_RUN_DURATION:-3600s}"
...
export CONTAINER_VM_LABEL="${CONTAINER_VM_LABEL:-cos-121-18867-90-106}"
