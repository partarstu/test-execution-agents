...
export BOUNDING_BOX_ALREADY_NORMALIZED="${BOUNDING_BOX_ALREADY_NORMALIZED:-true}"

# --- Agent Model Configuration ---
# Element Bounding Box Agent
export ELEMENT_BOUNDING_BOX_AGENT_MODEL_NAME="${ELEMENT_BOUNDING_BOX_AGENT_MODEL_NAME:-gemini-3-flash-preview}"
export ELEMENT_BOUNDING_BOX_AGENT_MODEL_PROVIDER="${ELEMENT_BOUNDING_BOX_AGENT_MODEL_PROVIDER:-google}"
