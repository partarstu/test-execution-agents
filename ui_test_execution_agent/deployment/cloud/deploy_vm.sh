...
gcloud beta compute instances create ${INSTANCE_NAME} \
    ...
    --metadata=enable-osconfig=TRUE,\
      ...
      no-vnc-port=${NO_VNC_PORT},\
      vnc-port=${VNC_PORT},\
      agent-server-port=${AGENT_SERVER_PORT},\
      app-final-log-folder=${APP_LOG_FINAL_FOLDER},\
      VNC_RESOLUTION=${VNC_RESOLUTION},\
      LOG_LEVEL=${LOG_LEVEL},\
      UNATTENDED_MODE=${UNATTENDED_MODE},\
      DEBUG_MODE=${DEBUG_MODE},\
      java-app-startup-script=${JAVA_APP_STARTUP_SCRIPT},\
      BBOX_SCREENSHOT_LONGEST_ALLOWED_DIMENSION_PIXELS=${BBOX_SCREENSHOT_LONGEST_ALLOWED_DIMENSION_PIXELS},\
      BBOX_SCREENSHOT_MAX_SIZE_MEGAPIXELS=${BBOX_SCREENSHOT_MAX_SIZE_MEGAPIXELS},\
      BOUNDING_BOX_ALREADY_NORMALIZED=${BOUNDING_BOX_ALREADY_NORMALIZED},\
      ELEMENT_BOUNDING_BOX_AGENT_MODEL_NAME=${ELEMENT_BOUNDING_BOX_AGENT_MODEL_NAME},\
      ELEMENT_BOUNDING_BOX_AGENT_MODEL_PROVIDER=${ELEMENT_BOUNDING_BOX_AGENT_MODEL_PROVIDER},\
      ELEMENT_BOUNDING_BOX_AGENT_PROMPT_VERSION=${ELEMENT_BOUNDING_BOX_AGENT_PROMPT_VERSION},\
      ELEMENT_SELECTION_AGENT_MODEL_NAME=${ELEMENT_SELECTION_AGENT_MODEL_NAME},\
      ELEMENT_SELECTION_AGENT_MODEL_PROVIDER=${ELEMENT_SELECTION_AGENT_MODEL_PROVIDER},\
      ELEMENT_SELECTION_AGENT_PROMPT_VERSION=${ELEMENT_SELECTION_AGENT_PROMPT_VERSION},\
      PAGE_DESCRIPTION_AGENT_MODEL_NAME=${PAGE_DESCRIPTION_AGENT_MODEL_NAME},\
      PAGE_DESCRIPTION_AGENT_MODEL_PROVIDER=${PAGE_DESCRIPTION_AGENT_MODEL_PROVIDER},\
      PAGE_DESCRIPTION_AGENT_PROMPT_VERSION=${PAGE_DESCRIPTION_AGENT_PROMPT_VERSION},\
      PRECONDITION_AGENT_MODEL_NAME=${PRECONDITION_AGENT_MODEL_NAME},\
      PRECONDITION_AGENT_MODEL_PROVIDER=${PRECONDITION_AGENT_MODEL_PROVIDER},\
      PRECONDITION_AGENT_PROMPT_VERSION=${PRECONDITION_AGENT_PROMPT_VERSION},\
      PRECONDITION_VERIFICATION_AGENT_MODEL_NAME=${PRECONDITION_VERIFICATION_AGENT_MODEL_NAME},\
      PRECONDITION_VERIFICATION_AGENT_MODEL_PROVIDER=${PRECONDITION_VERIFICATION_AGENT_MODEL_PROVIDER},\
      PRECONDITION_VERIFICATION_AGENT_PROMPT_VERSION=${PRECONDITION_VERIFICATION_AGENT_PROMPT_VERSION},\
      TEST_CASE_EXTRACTION_AGENT_MODEL_NAME=${TEST_CASE_EXTRACTION_AGENT_MODEL_NAME},\
      TEST_CASE_EXTRACTION_AGENT_MODEL_PROVIDER=${TEST_CASE_EXTRACTION_AGENT_MODEL_PROVIDER},\
      TEST_CASE_EXTRACTION_AGENT_PROMPT_VERSION=${TEST_CASE_EXTRACTION_AGENT_PROMPT_VERSION},\
      TEST_STEP_ACTION_AGENT_MODEL_NAME=${TEST_STEP_ACTION_AGENT_MODEL_NAME},\
      TEST_STEP_ACTION_AGENT_MODEL_PROVIDER=${TEST_STEP_ACTION_AGENT_MODEL_PROVIDER},\
      TEST_STEP_ACTION_AGENT_PROMPT_VERSION=${TEST_STEP_ACTION_AGENT_PROMPT_VERSION},\
      TEST_STEP_VERIFICATION_AGENT_MODEL_NAME=${TEST_STEP_VERIFICATION_AGENT_MODEL_NAME},\
      TEST_STEP_VERIFICATION_AGENT_MODEL_PROVIDER=${TEST_STEP_VERIFICATION_AGENT_MODEL_PROVIDER},\
      TEST_STEP_VERIFICATION_AGENT_PROMPT_VERSION=${TEST_STEP_VERIFICATION_AGENT_PROMPT_VERSION},\
      UI_ELEMENT_DESCRIPTION_AGENT_MODEL_NAME=${UI_ELEMENT_DESCRIPTION_AGENT_MODEL_NAME},\
      UI_ELEMENT_DESCRIPTION_AGENT_MODEL_PROVIDER=${UI_ELEMENT_DESCRIPTION_AGENT_MODEL_PROVIDER},\
      UI_ELEMENT_DESCRIPTION_AGENT_PROMPT_VERSION=${UI_ELEMENT_DESCRIPTION_AGENT_PROMPT_VERSION},\
      UI_STATE_CHECK_AGENT_MODEL_NAME=${UI_STATE_CHECK_AGENT_MODEL_NAME},\
      UI_STATE_CHECK_AGENT_MODEL_PROVIDER=${UI_STATE_CHECK_AGENT_MODEL_PROVIDER},\
      UI_STATE_CHECK_AGENT_PROMPT_VERSION=${UI_STATE_CHECK_AGENT_PROMPT_VERSION},\
